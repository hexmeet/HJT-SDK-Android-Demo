...
public class P2pCallActivity extends FullscreenActivity {
    ...
    private ImageView mCallerAvatar, mVideoIcon;
    private TextView mCallerName, mVideoText, mCallerType;
    private LinearLayout mCallerEnd, mCallerSwitchVideo;
    ...
    private void initView() {
        ...
        mCallerType = (TextView) findViewById(R.id.caller_type);
